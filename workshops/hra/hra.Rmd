...
Er zijn vier peildata. Voor dit onderzoek beperken we ons tot de record van het laatste jaar. Na de Onder de laatst peildatum staan personen die voor de startdatum van het jaar uit dienst zijn getreden. Bovendien zitten er dubbelingen in set. Na toepassing van een filter blijven de juiste records over. 
...
Eerder konden een aantal patronen visueel worden waargenomen. Hieronder worden ze getoetst m.b.v. ANOVA. Uiteindelijk blijkt er alleen een statistische relatie te zijn tussen FTE en geslacht. De bijbehorende boxplot deed dit al vermoeden.
